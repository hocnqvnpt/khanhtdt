...
Select * from TTKD_BSC.blkpi_danhmuc_kpi where thang = 202502 and ten_kpi like 'Số lượng công tác nghiệp vụ, hậu mãi, CSKH';
Select * from TTKD_BSC.blkpi_danhmuc_kpi where thang = 202502 and ma_kpi in ('HCM_SL_CSKHH_004');
--=== KIEM TRA VTCV THEO MA_KPI - KIỂM TRA ĐẠ ĐỦ VỊ TRÍ CV NHƯ THEO VB HAY CHƯA
Select * from TTKD_BSC.blkpi_danhmuc_kpi_vtcv where thang = 202502 and ma_kpi = 'HCM_SL_CSKHH_004';
Select * From ttkd_bsc.nhanvien
Where thang = 202502 and donvi = 'TTKD'
      and ma_vtcv in ('VNP-HNHCM_KDOL_22','VNP-HNHCM_KDOL_16.1','VNP-HNHCM_KDOL_16.2','VNP-HNHCM_KDOL_16.3') Order by ten_pb;  --34 nv tinh_bsc = 1 - vb thang 11/2024 đã bỏ mã của KHDN
...
--====================================================================================================--
Select * From ttkd_bsc.bangluong_kpi Where thang = 202502 and MA_KPI = 'HCM_SL_CSKHH_004' Order by ma_pb, ma_vtcv; -- 34 nv
--=====
...
--====================================================================================================--
Select * From TTKD_BSC.BLKPI_DANHMUC_KPI Where thang = 202502 and ma_kpi = 'HCM_SL_CSKHH_004';
--===
