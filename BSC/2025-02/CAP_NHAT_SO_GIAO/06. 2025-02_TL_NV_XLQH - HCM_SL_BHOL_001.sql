...
Select * from TTKD_BSC.blkpi_danhmuc_kpi where thang = 202502 and ten_kpi like 'Tỷ lệ nghiệp vụ xử lý quá hạn';
Select * from TTKD_BSC.blkpi_danhmuc_kpi where thang = 202502 and ma_kpi in ('HCM_SL_BHOL_001');
--=== KIEM TRA VTCV THEO MA_KPI - KIỂM TRA ĐẠ ĐỦ VỊ TRÍ CV NHƯ THEO VB HAY CHƯA
Select * from TTKD_BSC.blkpi_danhmuc_kpi_vtcv where thang = 202502 and ma_kpi = 'HCM_SL_BHOL_001';
Select * from TTKD_BSC.nhanvien
where thang = 202502 and donvi = 'TTKD'
      and ma_vtcv in ('VNP-HNHCM_KDOL_2','VNP-HNHCM_KDOL_16.3','VNP-HNHCM_KDOL_22','VNP-HNHCM_KDOL_24.1','VNP-HNHCM_KDOL_18','VNP-HNHCM_KDOL_23'); --21 nv: 19 nv tinh_bsc = 1 + 2 pgd
...
--===== THEO BUOI HOP NGÀY 28/11/2024 - SỐ GIAO TÍNH THEO MỨC ĐỘ HOÀN THÀNH 100%
--====================================================================================================--
Select * From ttkd_bsc.bangluong_kpi Where thang = 202502 and MA_KPI = 'HCM_SL_BHOL_001' Order by ma_pb, ma_vtcv;
--=====
...
Commit;
--====================================================================================================--
Select * From TTKD_BSC.BLKPI_DANHMUC_KPI Where thang = 202502 and NGUOI_XULY = 'Khanh' and ma_kpi = 'HCM_SL_BHOL_001';
--===
...
--    Select (202502)THANG, 'HCM_SL_BHOL_001' ma_kpi, nv.ma_nv, nv.ma_to, nv.ma_pb
--		   , a.*
