...
--===== THEO VTCT VÀ MA KPI
Select * from TTKD_BSC.blkpi_danhmuc_kpi where thang = 202502 and ten_kpi in ('Số lượng cuộc gọi OB thành công');
Select * From TTKD_BSC.blkpi_danhmuc_kpi_vtcv Where thang = 202502 and ma_kpi like 'HCM_CL_TNGOI_006';
Select * From ttkd_bsc.nhanvien Where thang = 202502 and ma_vtcv in ('VNP-HNHCM_KDOL_24') and tinh_bsc = 1; --3 nv tính bsc
...
--====================================================================================================--
Select * From TTKD_BSC.BANGLUONG_KPI Where thang = 202502 and ma_kpi in ('HCM_CL_TNGOI_006') Order by ten_pb; --3 nv
...
--====================================================================================================--
Select * From TTKD_BSC.BLKPI_DANHMUC_KPI Where thang = 202502 and ma_kpi = 'HCM_CL_TNGOI_006';
--===
