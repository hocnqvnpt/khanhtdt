...
Select * From ttkd_bsc.nhanvien Where thang = to_char(trunc(sysdate, 'month')-1, 'yyyymm') and ma_vtcv in ('VNP-HNHCM_KDOL_24'); --2 nv tinh_bsc = 1
...
Select * From TTKD_BSC.bangluong_kpi Where thang = to_char(trunc(sysdate, 'month')-1, 'yyyymm') and ma_kpi in ('HCM_CL_TNGOI_006') and ma_nv in ('VNP017695','VNP016812');
Select * From ttkd_bsc.nhanvien Where thang = to_char(trunc(sysdate, 'month')-1, 'yyyymm') and ma_vtcv in ('VNP-HNHCM_KDOL_24') and ma_nv in ('VNP017695','VNP016812');
--====================================================================================================--
