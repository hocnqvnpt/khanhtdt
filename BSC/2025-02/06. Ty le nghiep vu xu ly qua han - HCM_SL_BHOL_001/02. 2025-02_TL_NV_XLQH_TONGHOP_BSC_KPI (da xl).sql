...
--=== FILE KQ
Select * From KHANHTDT_TTKD.bsc_ton_quahan Where thang = to_char(trunc(sysdate, 'month')-1, 'yyyymm'); --and to_char(a.ngay_cn,'yyyymmdd') = '' and ma_nv = 'CTV086121';
--====================================================================================================--
...
(   
	Select nv.thang, (1)LOAI, ('KPI_NV')LOAI_KPI, ('HCM_SL_BHOL_001')MA_KPI, ('Tỷ lệ nghiệp vụ xử lý quá hạn')TEN_KPI
           ...
           , (20)NGAYCONG_CHUAN, a.SO_GIAO, a.SO_THUCHIEN
	From (
...
------------------------------------------------------- */
--Select * From KHANHTDT_TTKD.tonghop_bsc_kpi_2024 a Where thang = to_char(trunc(sysdate, 'month')-1, 'yyyymm') and ma_kpi = 'HCM_SL_BHOL_001' and exists ( Select 1 From A_ONL Where a.ma_nv = ma_nv );
--Delete From KHANHTDT_TTKD.tonghop_bsc_kpi_2024 a Where thang = to_char(trunc(sysdate, 'month')-1, 'yyyymm') and ma_kpi = 'HCM_SL_BHOL_001' and exists ( Select 1 From A_ONL Where a.ma_nv = ma_nv );
Insert Into KHANHTDT_TTKD.tonghop_bsc_kpi_2024
(   THANG, LOAI, LOAI_KPI, MA_KPI, TEN_KPI
    , MA_PB, MA_TO, MA_NV, MA_VTCV, TINH_BSC
    , NGAYCONG_CHUAN, SO_GIAO, SO_THUCHIEN
...
(   
	Select nv.thang, (1)LOAI, ('KPI_NV')LOAI_KPI, ('HCM_SL_BHOL_001')MA_KPI, ('Tỷ lệ nghiệp vụ xử lý quá hạn')TEN_KPI
           ...
           , (20)NGAYCONG_CHUAN, a.SO_GIAO, a.SO_THUCHIEN
	From (
			Select distinct ma_nv, SL_TH SO_GIAO, 0 SO_THUCHIEN
			From A_ONL
		 ) a
	Left join TTKD_BSC.nhanvien nv On nv.thang = to_char(trunc(sysdate, 'month')-1, 'yyyymm') and donvi = 'TTKD' and nv.ma_nv = a.ma_nv
);
...
--Delete From KHANHTDT_TTKD.tonghop_bsc_kpi_2024 Where thang = to_char(trunc(sysdate, 'month')-1, 'yyyymm') and ma_kpi = 'HCM_SL_BHOL_001' and loai = 2;
Insert Into KHANHTDT_TTKD.tonghop_bsc_kpi_2024
(   THANG, LOAI, LOAI_KPI, MA_KPI, TEN_KPI
    , MA_PB, MA_TO, MA_NV, MA_VTCV, TINH_BSC
    , NGAYCONG_CHUAN, SO_GIAO, SO_THUCHIEN
...
--Delete From KHANHTDT_TTKD.tonghop_bsc_kpi_2024 Where thang = to_char(trunc(sysdate, 'month')-1, 'yyyymm') and ma_kpi = 'HCM_SL_BHOL_001' and loai = 3;
Insert Into KHANHTDT_TTKD.tonghop_bsc_kpi_2024
(   THANG, LOAI, LOAI_KPI, MA_KPI, TEN_KPI
    , MA_PB, MA_NV, MA_VTCV
    , NGAYCONG_CHUAN, SO_GIAO, SO_THUCHIEN
...
(   --===== SAN LUONG PHO GIAM DOC PHU TRACH TO
	Select THANG, (3)LOAI, ('KPI_PB')LOAI_KPI, ('HCM_SL_BHOL_001')MA_KPI, ('Tỷ lệ nghiệp vụ xử lý quá hạn')TEN_KPI
           , MA_PB, MA_NV, MA_VTCV
           , (20)NGAYCONG_CHUAN, SO_GIAO, SO_THUCHIEN
