...
select distinct ngay_th From tuyenngo.SBH_CCOS_202502_CT Order by ngay_th;
select distinct THOI_GIAN_DOI From tuyenngo.SBH_ussd_202502_CT Order by THOI_GIAN_DOI;
select distinct NGAY_SUDUNG From tuyenngo.SBH_vinagift_202502_CT Order by NGAY_SUDUNG;

select * from ttkd_bsc.ct_bsc_nghiepvu where thang = 202502;
delete from ttkd_bsc.ct_bsc_nghiepvu where thang = 202502;
Commit;

/*	--khong chọn-------- VI VNPT ------------
	-- đã kiểm với anh Phương, tháng 02/2025 không có nv VNP phát triển
*/
...
-- File tháng 02/2025 NGAY_TH anh Tuyen định dạng dd/mm/yyyy
*/
...
-- File tháng 02/2025 THOI_GIAN_DOI anh Tuyen định dạng dd/mm/yyyy
*/
...
-- File tháng 02/2025 NGAY_SUDUNG anh Tuyen định dạng dd/mm/yyyy
*/
...
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
            where TEN_LOAIHD = 'CNTTTB' and 'CCBS' = loai and a.thang = 202502
                and exists (select * from  tuyenngo.sbh_vnp_202502_ct where ten_loaihd = 'CAP NHAT DB' and a.thang = thang and ma_tb = a.ma_tb)
    ;
...
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
    ...
    delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
            where TEN_LOAIHD = 'KY LAI HOP DONG GOC' and 'ONEBSS' = loai and a.thang = 202502
                and exists (select distinct TEN_LOAIHD, loai from  ttkd_bsc.ct_bsc_nghiepvu
    ...
    delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
            where TEN_LOAIHD = 'THAY THE/THU HOI/CAP BO SUNG VAT TU' and 'ONEBSS' = loai and a.thang = 202502
                and exists (select distinct TEN_LOAIHD, loai from  ttkd_bsc.ct_bsc_nghiepvu
...
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
    ...
    delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
            where TEN_LOAIHD = 'TACH NHAP THUE BAO' and 'ONEBSS' = loai and a.thang = 202502
                and exists (select * from  ttkd_bsc.ct_bsc_nghiepvu
...
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
    ...
    delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
            where TEN_LOAIHD = 'DONG MO DV|0' and 'CCBS' = loai and a.thang = 202502
    ...
    delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
            where TEN_LOAIHD = 'DONG MO DV|1' and 'CCBS' = loai and a.thang = 202502
...
--
select a.* from ttkd_bsc.ct_bsc_nghiepvu a where a.thang = 202502 and a.donvi = 'TTKD';
commit;
...
with tmp_nvch as (
	...
	Where a.thang = 202502 and trim(a.donvi) = 'TTKD'
...
, tmp_qd as (
    ...
    from (
            ...
            From (
                    ...
                    from tmp_nvch
                    where thang = 202502 and ten_loaihd in ('DONG MO DV|0','DONG MO DV|1')
                 )
    ...
    from (
            ...
            from tmp_nvch
            where thang = 202502 and ten_loaihd in ('DK/DC/HUY NGUONG CN','THAY DOI DICH VU')
         )
    ...
    from tmp_nvch
    where thang = 202502 and ten_loaihd in ('THU KHAC', 'THU CUOC')
    ...
    from tmp_nvch
    where thang=202502 and ten_loaihd='BIEN DONG KHAC'
    group by loai, ten_loaihd, ma_nv
)
...
/* -----------------------------------------------------------------------------------
--- NGHIỆP VỤ PHÒNG KHÁCH HÀNG DOANH NGHIỆP
...
/* -----------------------------------------------------------------------------------
--- NGHIỆP VỤ PHÒNG KHÁCH HÀNG DOANH NGHIỆP 2 - MA_NV in ('VNP033237','VNP028207')
--- DU LIEU TEST TONG QUAN ---
-------------------------------------------------------------------------------------- */
with tmp_nv as (
    select a.*
    from ttkd_bsc.ct_bsc_nghiepvu a
...
select * from tbl1 Where MA_NV in ('VNP033237','VNP028207') Order by MA_NV;
