...
update SBH_vinagift_202412_CT a set a.manv_hrm=(select manv_hrm from ttkd_bsc.nhanvien where ma_nv=upper(manv_cn) and thang=202410)
...
create table SBH_VNP_202412_CT as
--insert into SBH_VNP_202412_CT (ma_kh,ma_tb,loai_tb, manv_ra_pct, tennv_ra_pct,ma_vtcv, ten_vtcv, mato_ra_pct, tento_ra_pct, mapb_ra_pct, tenpb_ra_pct, user_cn, ngay_cn, ten_loaihd, ma_gd)
...
commit ;
update SBH_VNP_202412_CT a set (ma_kh, ma_gd) = (select ma_kh, ma_hd from danhba_dds_092024 where somay=a.ma_tb)
-- select * from SBH_VNP_202412_CT a
...
select * from ttkd_bsc.ct_bsc_nghiepvu where thang = 202412;
delete from ttkd_bsc.ct_bsc_nghiepvu where thang = 202412;
Commit;
...
insert into ttkd_bsc.ct_bsc_nghiepvu (THANG, MA_TB, NGAY_DKY_VI, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, ten_vtcv, MA_VTCV, MA_TO, MA_PB, LOAI, TEN_LOAIHD)
    ...
    where ngay_dky_vi between to_date('01/12/2024 00:00:01','dd/mm/yyyy hh24:mi:ss') and to_date('31/12/2024 23:59:59','dd/mm/yyyy hh24:mi:ss') 
...
insert into ttkd_bsc.ct_bsc_nghiepvu (THANG, MA_TB, NGAY_DKY_VI, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, TEN_VTCV, MA_VTCV, MA_TO, MA_PB, LOAI, TEN_LOAIHD)
    ...
    from ttkdhcm_ktnv.hcm_vmoney_ketqua a
        join ttkd_bsc.nhanvien nv on nv.donvi = 'TTKD' and a.ma_hrm = nv.ma_nv and nv.thang = a.thang
    where ngay_dky_mm between to_date('01/12/2024 00:00:01','dd/mm/yyyy hh24:mi:ss') and to_date('31/12/2024 23:59:59','dd/mm/yyyy hh24:mi:ss') 
...
insert into ttkd_bsc.ct_bsc_nghiepvu (THANG, MA_TB, NGAY_DKY_VI, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, TEN_VTCV, MA_VTCV, MA_TO, MA_PB, LOAI, TEN_LOAIHD)
    ...
    from ttkdhcm_ktnv.HCM_VNPTAPP_ACTIVE a
        join ttkd_bsc.nhanvien nv on nv.donvi = 'TTKD' and a.ma_hrm = nv.ma_nv and nv.thang = a.thang
    where ngay_active between to_date('01/12/2024 00:00:01','dd/mm/yyyy hh24:mi:ss') and to_date('31/12/2024 23:59:59','dd/mm/yyyy hh24:mi:ss') 
;
commit ;
/*----HauMai-Muc 4-----CCOS - KHIEU NAI - TIEPNHAN--------*/
	...
	insert into ttkd_bsc.ct_bsc_nghiepvu (thang, MA_PA, MA_TB, NGHIEPVU, USER_CCOS, TEN_LOAIHD, LOAI, NGAY_DKY_VI, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, TEN_VTCV, MA_VTCV, MA_TO, MA_PB)
				select nv.thang, MA_PA, MA_TB, LOAI_KHIEUNAI || '; '|| LINHVUC_CHUNG || '; '|| LINHVUC_CON NGHIEPVU, a.USER_CCOS, 'KHIEU NAI - TIEP NHAN' TEN_LOAIHD, 'CCOS' loai
							, to_date(NGAY_TH, 'mm/dd/yyyy hh24:mi') NGAY_TH, nv.donvi, nv.ma_nv, nv.ten_nv, nv.ten_to, nv.ten_pb, nv.ten_vtcv, nv.ma_vtcv, nv.ma_to, nv.ma_pb
...
insert into ttkd_bsc.ct_bsc_nghiepvu (MA_TB, NGHIEPVU, NGAY_DKY_VI, TEN_LOAIHD, LOAI, USER_CCOS, THANG, DONVI, MA_NV, TEN_NV, TEN_TO, TEN_PB, TEN_VTCV, MA_VTCV, MA_TO, MA_PB)
	select SO_SERI, MUCDICH_SD, to_date(NGAY_SUDUNG,'mm/dd/yyyy') NGAY_SUDUNG, 'VINAGIFT' TEN_LOAIHD, 'VINAGIFT' loai, MANV_CN
			, nv.thang, nv.donvi, nv.ma_nv, nv.ten_nv, nv.ten_to, nv.ten_pb, nv.ten_vtcv, nv.ma_vtcv, nv.ma_to, nv.ma_pb
...
-- Theo MA_KN  
	...
	create table khanhtdt_ttkd.x_temp_kn aS
        ...
        where a.ngay_tn between to_date('01/12/2024','dd/mm/yyyy') and to_date('31/12/2024','dd/mm/yyyy')
	 ;
...
-- Theo MA_KN
	...
	create table khanhtdt_ttkd.x_temp_gqkn aS 
        ...
        from qltn.v_khieunai@dataguard a
        where a.ngay_gq between to_date('01/12/2024','dd/mm/yyyy') and to_date('31/12/2024','dd/mm/yyyy')
	 ;
...
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
            where TEN_LOAIHD = 'CNTTTB' and 'CCBS' = loai and a.thang = 202412
                and exists (select * from  tuyenngo.sbh_vnp_202412_ct where ten_loaihd = 'CAP NHAT DB' and a.thang = thang and ma_tb = a.ma_tb)
    ;
...
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
    ...
    delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
            where TEN_LOAIHD = 'DONG MO DV|0' and 'CCBS' = loai and a.thang = 202412
    ...
    delete from ttkd_bsc.ct_bsc_nghiepvu a
--			select * from ttkd_bsc.ct_bsc_nghiepvu a
            where TEN_LOAIHD = 'DONG MO DV|1' and 'CCBS' = loai and a.thang = 202412
...
--
select a.* from ttkd_bsc.ct_bsc_nghiepvu a where a.thang = 202412 and a.donvi = 'TTKD';
commit;
...
select * from tbl1 Where MA_PB in ('VNP0702300','VNP0702400','VNP0702500') Order by MA_PB;
...
, tbl1 as (				
                ...
                from tmp_nv a
                    join ttkd_bsc.nhanvien nv on a.ma_nv = nv.ma_nv and nv.thang = 202412
                where a.thang = 202412 and a.donvi = 'TTKD' and LOAI = 'CCBS'
                      and TEN_LOAIHD not in ('HMM TRA SAU', 'DOI SIM', 'DANG KY HUY CHUYEN DOI GOI CUOC', 'DONG MO DV|0', 'DONG MO DV|1', 'DONG TRUOC GOI CUOC')	--ĐK 2024-11
					  and exists (  Select 1 From ttkd_bct.cuoc_thuebao_ttkd where loaitb_id = 149 and ma_tb = a.ma_tb )	--ĐK 2024-11 tách VCC
                group by LOAI, TEN_LOAIHD, a.MA_PB, a.TEN_PB, a.MA_TO, a.TEN_TO, a.ma_nv, a.ten_nv, nv.ten_vtcv
                order by LOAI, TEN_LOAIHD
